...
* The original package name 'com.example.article-management' is invalid and this project uses 'com.example.articlemanagement' instead.
...
* [Prometheus](https://docs.spring.io/spring-boot/docs/2.7.0/reference/htmlsingle/#production-ready-metrics-export-prometheus)
